package com.example.mapsforgewithjavafx.controller;

import com.example.mapsforgewithjavafx.SWINGApplication;
...
public class MainController {
    ...
    public void initialize() {
        ...
        jPane.setSize((int)anchorPane.getPrefWidth(), (int)anchorPane.getPrefHeight());
        mapView.setBounds(0,0, jPane.getWidth(), jPane.getHeight());
        jPane.add(mapView);
        jPane.setVisible(true);
        jPane.repaint();

        // Компонент для работы SWING в JAVAFX (добавляем контейнер SWING с картой)
        SwingNode swingNode = new SwingNode();
        swingNode.setContent(jPane);

        // Anchor to the Top + Left + Right + Bottom
        AnchorPane.setTopAnchor(swingNode, 0.0);
        AnchorPane.setLeftAnchor(swingNode, 0.0);
        AnchorPane.setRightAnchor(swingNode, 0.0);
        AnchorPane.setBottomAnchor(swingNode, 0.0);
        // Добавляем SWING mapPane в наш MapPaneFX
